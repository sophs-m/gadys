...
const headerImage = require('../../../assets/images/ms/bonito.png');
...
const places: Place[] = [
  { name: 'Bonito', category: 'Outro', location: 'Bonito', description: 'Capital do ecoturismo brasileiro, com rios de águas cristalinas, grutas e a maior diversidade de peixes de água doce do mundo.', image: bonitoImage, rating: 5 },
  { name: 'Pantanal Sul', category: 'Outro', location: 'Corumbá', description: 'A porção sul do Pantanal, com fazendas históricas, aves raras e uma natureza exuberante acessível pela Estrada Parque.', image: pantanalImage, rating: 5 },
];
        ...
        <View style={styles.content}>
          {activeTab === 'Historia' ? (
            <View style={styles.historyContainer}>
              <Text style={styles.historyTitle}>A Separação do Mato Grosso e o Pantanal do Sul</Text>
              <Text style={styles.historyText}>O Mato Grosso do Sul é o estado mais novo do Brasil central, resultado de um processo político que refletia as tensões entre o norte e o sul do antigo Mato Grosso.</Text>
              <Text style={styles.historySubtitle}>As Origens e a Divisão</Text>
              <Text style={styles.historyText}>A ocupação do sul de Mato Grosso se deu principalmente pela pecuária e pela expansão da ferrovia. A região sul, mais próxima de São Paulo e com uma economia distinta do norte minerador, lutou por décadas pela emancipação. Em 11 de outubro de 1977, o presidente Ernesto Geisel assinou a lei que criou o estado de Mato Grosso do Sul, com Campo Grande como capital, que foi instalado oficialmente em 1979.</Text>
              <Text style={styles.historySubtitle}>A Influência Paraguaia e Boliviana</Text>
              <Text style={styles.historyText}>A fronteira seca com o Paraguai e a Bolívia moldou profundamente a cultura sul-mato-grossense. A culinária, a música (como o chamamé) e o idioma (com forte presença do guarani no cotidiano) refletem essa rica mistura de influências que distingue o estado do restante do país.</Text>
            </View>
          ) : renderCulturaLocal()}
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  historyTitle: { fontSize: 22, fontWeight: 'bold', color: '#388e3c', marginBottom: 15, textAlign: 'center' },
  historySubtitle: { fontSize: 18, fontWeight: 'bold', color: '#388e3c', marginTop: 15, marginBottom: 5 },
  historyText: { fontSize: 16, color: '#333', lineHeight: 24, marginBottom: 10 },
  categoryHeader: { fontSize: 20, fontWeight: 'bold', color: '#388e3c', marginTop: 15, marginBottom: 5 },
  separator: { height: 1, backgroundColor: '#c8e6c9', marginVertical: 10, marginBottom: 15 },
  ...
  cardTitle: { fontSize: 18, fontWeight: 'bold', color: '#388e3c' },
  ...
  modalTitle: { fontSize: 20, fontWeight: 'bold', color: '#388e3c', marginBottom: 5 },
  ...
  closeButton: { backgroundColor: '#388e3c', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 20 },
